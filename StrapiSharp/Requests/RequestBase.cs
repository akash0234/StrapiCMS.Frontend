...
public abstract class RequestBase
{
    ...
    {
        SetFilter("populate", "*", string.Empty);
    }
    /// <summary>
    /// Change Language
    /// </summary>
    /// <param name="langId">Get Resouces by language id</param>
    public void Locale(string langId)
	{
		SetFilter("locale", langId, string.Empty);
	}
